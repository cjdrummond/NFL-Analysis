...
## function to fix the data for the passing stats
...
## function to fix the data for the receiving stats
...
## function to fix the data for the rushing stats
...
## function to fix the data for the basic stats
...
## function to merge the retired and active player data for each of the positional dataframes
...
## function to check the values in the basic dataframe and ask for user input if Height or Weight is 0
...
## function to merge the positional dataframes into one dataframe
...
## function to merge merged positional dataframe with basic stats dataframe
...
## function to write the dataframe to a csv file to preserve changes made for future analysis
